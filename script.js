...
document.querySelector('.gameframe').contentWindow.document.head.appendChild(Object.assign(document.createElement("style"), { innerHTML: ".room-view,.roomlist-view{height:100%;margin-top:0}.game-view>.top-section,.room-view{margin-top:0}.settings-view{width:100%;max-height:none}.game-view>[data-hook=popups]{background-color:#1a212585}.disconnected-view .dialog,.disconnected-view .room-view>.container{width:450px}.create-room-view>.dialog,.room-view.create-room-view>.container{max-width:450px;width:100%}body{background:#111417}[data-hook=leave-btn]{background:#c13535!important}.file-btn,[data-hook=rec-btn]{display:none!important}h1{text-align:center}.room-view>.container>.header-btns{bottom:0;right:10px;top:auto}.room-view>.container{max-width:none;max-height:max-content}.room-view{position:absolute;width:100%}.roomlist-view{display:flex;justify-content:center;align-items:center}.roomlist-view>.dialog{max-width:360px;width:88%;max-height:75vh;margin:auto;background:#111417;border:1px solid #2a2f35;border-radius:10px;overflow:hidden}.game-state-view .bar>.scoreboard{display:flex;align-items:center;margin-right:50px}.chatbox-view{position:absolute;left:10px;margin:0;top:5px;width:10%;pointer-events:none;font-size:0.5rem;display:contents}.chatbox-view-contents{flex-direction:column-reverse;background:0 0;pointer-events:none}.chatbox-view-contents>.input{margin-bottom:10px;pointer-events:auto}.chatbox-view-contents>.log{flex-direction:column;pointer-events:none;overflow-y:scroll;scrollbar-width:none}.settings-view .section.selected{display:flex;align-items:center}.log-contents{display:flex;flex-direction:column-reverse;text-shadow:1px 1px 5px #000000cc}.fade-out{opacity:0;transition:opacity 10s ease-out}thead tr{display:table-row!important}svg{width:1em}.input-options{position:absolute;width:100%;height:100%;z-index:20;background-color:#111417}.roomlist-view table{width:100%;border-collapse:collapse;font-size:0.75rem}.roomlist-view td,.roomlist-view th{padding:5px 6px}.roomlist-view thead tr{background:#1a1f24;color:#8a9bb0;font-size:0.75rem;text-transform:uppercase;letter-spacing:1px}.roomlist-view tbody tr{border-bottom:1px solid #1e2329;transition:background 0.15s}.roomlist-view tbody tr:hover{background:#1a1f24}.roomlist-view .dialog h1{font-size:1.1rem;color:#fff;padding:14px 16px 0;margin:0}.roomlist-view .dialog>p{color:#8a9bb0;font-size:0.8rem;padding:2px 16px 10px;margin:0}.roomlist-view .filters{padding:6px 16px;background:#0f1215;border-bottom:1px solid #1e2329}.roomlist-view .buttons{padding:8px 12px;background:#0f1215;border-top:1px solid #1e2329;gap:5px;flex-wrap:wrap;justify-content:center}.roomlist-view .buttons button{background:#1e2329;border:1px solid #2a3040;color:#cdd6e0;font-size:0.85rem;width:32px;height:32px;padding:0;display:flex;justify-content:center;align-items:center;border-radius:6px}.roomlist-view .buttons button div{display:none!important}.roomlist-view .buttons button:hover{background:#2a3040}.roomlist-view [data-hook=listscroll]{background:#111417}" }));
...
function setupChangelog() {
    ...
    changelogHandler.innerHTML = `
        <div style="background:#111417;border:1px solid #2a3040;border-radius:12px;max-width:380px;width:90%;overflow:hidden;">
            ...
            <div style="padding:16px 20px;display:flex;flex-direction:column;gap:10px;">
                ${[
                    ["FPS Counter", "Overlay activable desde Mod Options. Verde, amarillo o rojo segun rendimiento."],
                    ["Mod Options", "Submenu en Settings con todas las opciones del mod."],
                    ["Background", "Fondo custom por color o imagen URL."],
                    ["Turbo Kick", "Boton de disparo automatico con velocidad ajustable."],
                    ["Roomlist", "Nuevo diseno oscuro. Botones solo con iconos."],
                ].map(([title, desc]) => `
...
function createShareButton() {
    ...
    share.innerHTML = '<i class="icon-export"></i>';
...
function createStoreButton() {
    ...
    store.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 407 407" fill="white" style="height:1em;width:auto"><path d="M402 84 323 5c-3-3-7-5-12-5H17C8 0 0 8 0 17v373c0 9 8 17 17 17h373c9 0 17-8 17-17V96c0-4-2-9-5-12zm-101 80H67V39h234v125z"></path><path d="M214 148h43c3 0 6-2 6-6V60c0-4-3-6-6-6h-43c-3 0-6 2-6 6v82c0 4 3 6 6 6z"></path></svg>';
...
function setupControls() {
    ...
    turboButton.setAttribute("float", "");
    turboButton.setAttribute("id", "turbo");
    turboButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>';
    ...
    document.body.appendChild(turboButton);
