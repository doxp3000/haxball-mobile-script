...
function setupRoomlistSections() {
    ...
    lblOpciones.innerHTML = 'OPCIONES <span class="roomlist-arrow">▸</span>';
    ...
    lblSalas.innerHTML = 'SALAS <span class="roomlist-arrow">▸</span>';
    ...
    buttons.classList.add('roomlist-collapsed');
    listscroll.classList.add('roomlist-collapsed');

    function toggleSection(label, content) {
        content.classList.toggle('roomlist-collapsed');
        const arrow = label.querySelector('.roomlist-arrow');
        if (arrow) arrow.innerHTML = content.classList.contains('roomlist-collapsed') ? '▸' : '▾';
    }

    lblOpciones.addEventListener('click', function() { toggleSection(lblOpciones, buttons); });
    lblSalas.addEventListener('click', function() { toggleSection(lblSalas, listscroll); });
}
